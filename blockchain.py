...
class Blockchain:
    ...
    def __init__(self) -> None:
        """
        The initialization function defines the chain as a string, sets the values of the first block or genesis block, 
    ...
    def mine_block(self, data: str) -> dict:
        """
        "Mining" is the word used to create a new block in the chain. It depends on a "proof of work" and hash function
        defined below to generate values for the new block.
        """
